...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'ɴᴏɪʀ;ᴊᴀʀᴠɪꜱ;https://graph.org/file/58ea74675af7836579a3a.jpg',
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_18zy_3292_6799_z6xz_642w_w287_9589_84ux',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "ᴊᴀʀᴠɪꜱ-ᴍᴅ", "body": "ᴀᴡᴇꜱᴏᴍᴇ 🍉", "thumbnailUrl": "https://files.catbox.moe/ht078n.jpeg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Loki-Xer/Jarvis-md", "showAdAttribution": true}`,
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '⎯⎯ּ︭   🧸̼᪲ 𝐍𝐎𝐈𝐑  ❜❜ ᪶,(⁠ ⁠◜⁠‿⁠◝⁠ ⁠)⁠♡',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;ᴊᴀʀᴠɪꜱ-ᴍᴅ;https://files.catbox.moe/ht078n.jpeg',
  ...
  BOT_INFO: process.env.BOT_INFO || 'ᴊᴀʀᴠɪꜱ;ɴᴏɪʀ;https://graph.org/file/1506e5842805b0968c5cf.mp4',
